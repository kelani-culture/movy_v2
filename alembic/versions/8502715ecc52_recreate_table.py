...
Revision ID: 8502715ecc52
Revises: 13bfeaae4caa
Create Date: 2024-11-05 17:24:38.290730
...
revision: str = '8502715ecc52'
down_revision: Union[str, None] = '13bfeaae4caa'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('row_name', sa.String(length=1), nullable=True),
